...
public class Programme_10_Tubeline_advanced {
    public static void main(String[] args) {
        ...
        String station [] = (" Aldgate,Angle, Baker Street,Bank, Barbican, bayswater,blackfriars,bond stre et," +
                ...
                "Farr ingdon,gloucester road,Goodgs street,Great portland street,green park").split(",");
