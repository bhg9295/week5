...
public class Programme_10_Tubeline {
    public static void main(String[] args) {
        ...
        String[] tubeStationZone1 = new String[]{"Aldgate", "Aldgate East", "Angel", "Baker Street", "Bank", "Barbican", "Bayswater", "Blackfriars",
                ...
                "Goodge Street", "Great Portland Street", "Green Park", "High Street Kensington", "Hol born", "Hyde Park Corner", "King's Cross",
                "Knights bridge", "Lambeth North", "Lancaster Gate", "Leicester Square", "Liverpool Street", "London Bridge", "Mansion House",
                "Marble Arch", " Marylebone", "Monumen", "Moorgate", " Notting Hill Gate", "Old Street", "Oxford Circus", "Paddington",
                ...
                "Tower Hill", "Vaux hall", "Vict oria", "Warren Street", "Waterloo East", " Waterloo", "Westminster"};
        ...
        londonUGLines[2][10] = "Euston Sq uare";
